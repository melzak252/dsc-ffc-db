...
from visualization import prepare_data_for_material_plots, plot_hazardous_count, plot_hazardous_percentage, plot_hazardous_pie_chart, plot_material_count
...
def main() -> None:
    ...
    parser.add_argument("--config", help="Change default constants config file to custom.")
